...
public partial class BasepersonMdfContext : DbContext
{
    ...
    public virtual DbSet<PersDepartment> PersDepartments { get; set; }

    public virtual DbSet<PersDivision> PersDivisions { get; set; }

    public virtual DbSet<PersFilial> PersFilials { get; set; }
