...
public partial class DsuContext : DbContext
{
    ...
    public virtual DbSet<CaseCEdue> CaseCEdues { get; set; }

    public virtual DbSet<CaseCEdukind> CaseCEdukinds { get; set; }

    public virtual DbSet<CaseCPlat> CaseCPlats { get; set; }

    public virtual DbSet<CaseCStatus> CaseCStatuses { get; set; }

    public virtual DbSet<CaseSDepartment> CaseSDepartments { get; set; }

    public virtual DbSet<CaseSSpecialization> CaseSSpecializations { get; set; }

    public virtual DbSet<CaseSStudent> CaseSStudents { get; set; }

    public virtual DbSet<CaseSTeacher> CaseSTeachers { get; set; }

    public virtual DbSet<CaseUkoExam> CaseUkoExams { get; set; }

    public virtual DbSet<CaseUkoModule> CaseUkoModules { get; set; }

    public virtual DbSet<CaseUkoZachet> CaseUkoZachets { get; set; }
